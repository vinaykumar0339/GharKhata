...
const baseExpense = { ownerId: 'user-a', createdBy: 'user-a', projectId: 'project-a', date: '2026-08-21', stageId: 'foundation', categoryId: 'cement', item: 'Cement', description: '', paidById: 'cash', paymentStatusId: 'paid', notes: '', createdAt: '', updatedAt: '' };
...
test('budget actuals use relationships by ID and mark overruns', () => {
  ...
  const categories = [{ id: 'cement', ownerId: 'user-a', projectId: 'project-a', name: 'Cement', type: 'categories' as const, createdAt: '', updatedAt: '' }];
  const budget = { id: 'project-a', ownerId: 'user-a', projectId: 'project-a', totalBudget: 500000, categoryBudgets: [{ categoryId: 'cement', amount: 500000 }], updatedAt: '' };
