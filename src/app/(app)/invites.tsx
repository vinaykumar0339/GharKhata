...
export default function Invites() {
  ...
  const accept = async (invite: ProjectInvite) => {
    ...
    try { await inviteRepository.accept(user.uid, invite); await profileRepository.selectProject(user.uid, invite.projectId); Alert.alert('Project joined', 'You can now collaborate on the project.'); }
