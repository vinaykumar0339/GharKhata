...
const styles = StyleSheet.create({
  ...
  sectionHeading: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12, marginTop: 4 }, sectionTitle: { color: colors.ink, fontWeight: '800', fontSize: 18, flex: 1, flexShrink: 1, minWidth: 0 }, sectionAction: { color: colors.forest, fontWeight: '800', fontSize: 13, flexShrink: 0, textAlign: 'right' },
