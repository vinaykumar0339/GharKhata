...
import type { Budget, Expense, ExpenseFilters, MasterItem, MasterType, Project, ProjectMember } from '@/types/domain';
...
export function useProjectMembers(projectId?: string) { const [members, setMembers] = useState<ProjectMember[]>([]); useEffect(() => projectId ? projectMemberRepository.watch(projectId, setMembers) : undefined, [projectId]); return members; }
