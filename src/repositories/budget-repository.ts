...
export const budgetRepository = {
  ...
  save(ownerId: string, projectId: string, totalBudget: number, categoryBudgets: CategoryBudget[]) { return putOwned('budgets', projectId, { ownerId, projectId, totalBudget, categoryBudgets, updatedAt: new Date().toISOString() }); },
};
